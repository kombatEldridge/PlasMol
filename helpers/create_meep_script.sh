...
if [ "$submit_choice" = "slurm" ]; then
    ...
    time_limit=$(ask_with_default "    Enter the time limit (e.g., 14-00:00:00)" "$time_limit" "^([0-9]{1,2}-)?[0-9]{2}:[0-9]{2}:[0-9]{2}" "Please enter a valid time limit format (e.g., 14-00:00:00).")
