...
## Specialized methodology pages

| Topic | Page |
| ------- | ------ |
| Fourier absorption (quantum + hybrid, **parallel/perpendicular**) | [Fourier Spectra](methodology/fourier.md) |
| Gersten–Nitzan \(\alpha_{\mathrm{eff}}\) and fits to PlasMol | [Effective Polarizability](methodology/effective_polarizability.md) |
| Sudden SCH/DCH core-hole dynamics | [Core-Hole Dynamics](methodology/core_hole.md) |

These pages document the major theoretical and workflow additions in **v1.2.0**.
